...
module.exports = {
  entry: {app: "./src/index.js",            // Where the bundling should start bundling
          vendor: "./src/vendor.js"},       // Where the bundling should start bundling
  module: {
    rules: [
      {
      ...
      {
        test: /\.(svg|png|jpg|jpeg|gif)$/,   // What type of assets include
        use: {
